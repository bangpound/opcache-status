...
function set_text(t) {
    if (t === "memory") {
        d3.select("#stats").html(
            "<table><tr><th style='background:#B41F1F;'>Used</th><td>"+humanReadable.human_used_memory+"</td></tr>"+
            "<tr><th style='background:#1FB437;'>Free</th><td>"+humanReadable.human_free_memory+"</td></tr>"+
            "<tr><th style='background:#ff7f0e;' rowspan=\"2\">Wasted</th><td>"+humanReadable.human_wasted_memory+"</td></tr>"+
            "<tr><td>"+humanReadable.wasted_memory_percentage+"%</td></tr></table>"
        );
    } else if (t === "keys") {
        d3.select("#stats").html(
